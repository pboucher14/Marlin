 ...
 */
#define E0_AUTO_FAN_PIN P2_04 // PBO Changed for SKR V1.3 board. Original value -1
                              // Allows to turn heater fan at a specific temperature 
...
#define HOMING_BUMP_MM      { 0, 0, 2 }       // PBO changed from { 5, 5, 2 }. (linear=mm, rotational=°) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 2, 2, 4 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)

//#define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  // (linear=mm, rotational=°) Backoff from endstops after homing
//#define XY_COUNTERPART_BACKOFF_MM 0         // (mm) Backoff X after homing Y, and vice-versa

#define QUICK_HOME                          // PBO Uncommented. If G28 contains XY do a diagonal move first
 ...
 */
#define INPUT_SHAPING_X  // PBO Enabled
#define INPUT_SHAPING_Y  // PBO Enabled
  ...
  #define SHAPING_MENU                // PBO Enabled. Add a menu to the LCD to set shaping parameters.
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  //#define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0 // PBO uncommented to enable z offset wizard
  ...
  #define LCD_INFO_MENU // PBO changed from default wich is commented
  ...
  #define STATUS_MESSAGE_SCROLLING  // PBO changed from default wich is commented
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SCROLL_LONG_FILENAMES // PBO changed from default wich is commented
   ...
   */
    #define SDCARD_CONNECTION ONBOARD // PBO Added this line for SKR V1.3
 ...
 */
#define BABYSTEPPING // PBO changed from default wich is commented
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  4      // PBO changed from 1 to 4 // Babysteps are very small. Increase for faster motion.
  #define BABYSTEP_MULTIPLICATOR_XY 4      // PBO changed from 1 to 4

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING  // PBO changed from default wich is commented. Double-click on the Status Screen for Z Babystepping.
 ...
 #define BABYSTEP_ZPROBE_OFFSET  // PBO enabled for bltouch. Originally commented // Enable to combine M851 and Babystepping
 ...
 */
#define LIN_ADVANCE             // PBO enable linear pressure control
#if ENABLED(LIN_ADVANCE)
  #if ENABLED(DISTINCT_E_FACTORS)
    #define ADVANCE_K { 0.22 }    // (mm) Compression length per 1mm/s extruder speed, per extruder
  #else
    #define ADVANCE_K 0.22        // PBO change from 0.22 to 0 to disable by default. Use M900 to set K value. (mm) Compression length applying to all extruders
  #endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE // PBO Enabled. Originally commented
#if ENABLED(ADVANCED_PAUSE_FEATURE)
  #define PAUSE_PARK_RETRACT_FEEDRATE         30  // PBO changed from 60 to 30.(mm/s) Initial retract feedrate.
  #define PAUSE_PARK_RETRACT_LENGTH            5  // PBO changed from 2 to 5.(mm) Initial retract.
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     30  // PBO changed from 10 to 30. (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      450  // PBO changed from 100 to 450
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE  30  // PBO changed from 6 to 30. (mm/s) Load filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_FAST_LOAD_ACCEL     25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   350  // PBO changed from 0 to 350
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           300 // PBO Changed from 45 to 300 (seconds) Time limit before the nozzle is turned off for safety.
  #define FILAMENT_CHANGE_ALERT_BEEPS         10  // Number of alert beeps to play when a response is needed.
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                      // PBO Enabled for Pause M125. Park the nozzle during pause and filament change.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // PBO Enabled // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
  ...
  #define INTERPOLATE      true
      ...
      #define X_CURRENT       580 // PBO changed from 800    
    ...
    #define Y_CURRENT       580 // PBO changed from 800
    ...
    #define Z_CURRENT       580 // PBO changed from 800
    ...
    #define E0_CURRENT      500 // PBO changed from 800 (650 for stock extruder, 500 for Bondtech BMG)
   ...
   */
  #define MONITOR_DRIVER_STATUS // PBO uncommented
   ...
   */
   #define SENSORLESS_HOMING // PBO uncommented for TMC2209 // StallGuard capable drivers only
   ...
   */
    #define TMC_DEBUG // PBO uncommented for TMC2209
