...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // PBO Add a Probe Z Offset calibration option to the LCD menu
...
#define ADVANCED_PAUSE_FEATURE // PBO Enabled. Originally commented
  ...
  #define ADVANCED_PAUSE_RESUME_PRIME          2  // PBO changed from 0 to 2
                                                  //(mm) Extra distance to prime nozzle after returning from park.
