...
#define HOMING_BUMP_MM      { 0, 0, 2 }       // PBO changed from { 5, 5, 2 }. (mm) Backoff from endstops after first bump
...
#define ADVANCED_PAUSE_FEATURE // PBO Enabled. Originally commented
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH   400  // PBO changed from 0 to 400
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
