...
#define STRING_CONFIG_H_AUTHOR "(PBO, PBO_VER_5.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PBO Ver 5.2"
...
#define NOZZLE_TO_PROBE_OFFSET { -48, -10, -2.35 } // PBO Bullseye mount BLTouch on the left
